    ...
    const downloadID = async () => {
        try {
            ...
            if (response.ok) {
                ...
                alert('Digital ID not yet available for download');
            }
        } catch (error) {
        ...
        <div className={`p-4 lg:p-6 bg-white rounded-2xl shadow ${standalone ? 'max-w-lg mx-auto' : ''}`}>
            ...
            <div className="bg-gradient-to-r from-indigo-500 to-purple-500 rounded-xl p-4 lg:p-6 text-white relative">
                <div className="absolute top-3 right-3 lg:top-4 lg:right-4">
                    <ShieldIcon className="w-5 h-5 lg:w-6 lg:h-6" />
                </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 mt-4">
                <button 
                    ...
                    className={`flex-1 py-2 px-4 rounded-xl text-xs lg:text-sm font-medium transition-colors ${
